""""
NASA test case atmos 02: Dragless tumbling brick.
"""
...
def test_case02(plotting=False):
    FT_TO_M = 0.3048
    ...
    b = 0.33333 * FT_TO_M  # m^2, not actually needed as no aerodynamic effects are included
    c = 0.66667 * FT_TO_M  # m^2, not actually needed as no aerodynamic effects are included
    ...
    for i in range(nasa_sims_N):
        ...
        data_path_csv = "Atmos_02_TumblingBrickNoDamping/Atmos_02_sim_0{}.csv".format(i+1)
